...
const ShopCart = () => {
  ...
  const checkOut = () => {
    ...
    axios
      .patch("/shoppingitem/arraypost", body)
        ...
        <div style={{ textAlign: "center", marginTop: "20px" }}>
                      ...
                      <span>
                        {cart.quantity <= 1 ? (
                          ...
                          <i
                            ...
                            onClick={() => addcart(cart.products._id, "remove")}
                          ></i>
                        )}{" "}
                      </span>
          ...
          <div className="my-3" style={{ textAlign: "left", padding: "5px" }}>
            ...
            <span className="text-muted">
              Delivery Fee:{" "}
              <span style={{ float: "right", paddingRight: "30px" }}>Tk 0</span>
            </span>
            <br />
            <span className="text-muted">
              VAT:{" "}
            ...
            <br />
            {/* <button onClick={checkOut} className="checkbtn">
              Check Out
            </button> */}
			<Link to='/cart' className="checkbtn"><i className="fas fa-shopping-cart"></i> Check Cart</Link>
          </div>
        </div>
      </div>
              ...
              <div className="cart">
                <div style={{ textAlign: "center" }}>
                  ...
                  >
					...
					<a href='/cart' className="checkbtn"><i className="fas fa-shopping-cart"></i> Check Cart</a>
                  </div>
                </div>
              </div>
            </div>
