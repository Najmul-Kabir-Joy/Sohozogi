                            ...
                            <Tab.Content>
                                <Tab.Pane eventKey="first">
                                    <div className="lifestyle-card-container pt-1">
                                        <Row md={3} className='gap-0'>
                                            {
                                                items.map(item => item.type === 'cloth' ? <LifeStyleCard key={item.id} item={item} /> : null)
                                            }
                                        </Row>
                                    </div>
                                </Tab.Pane>
                                <Tab.Pane eventKey="second">
                                    <div className="lifestyle-card-container pt-1">
                                        <Row md={3} className='gap-0'>
                                            {
                                                items.map(item => item.type === 'shoes' ? <LifeStyleCard key={item.id} item={item} /> : null)
                                            }
                                        </Row>
                                    </div>
                                </Tab.Pane>
                                <Tab.Pane eventKey="third">
                                    <div className="lifestyle-card-container pt-1">
                                        <Row md={3} className='gap-0'>
                                            {
                                                items.map(item => item.type === 'sunglass' ? <LifeStyleCard key={item.id} item={item} /> : null)
                                            }
                                        </Row>
                                    </div>
                                </Tab.Pane>
                                <Tab.Pane eventKey="fourth">
                                    <div className="lifestyle-card-container pt-1">
                                        <Row md={3} className='gap-0'>
                                            {
                                                items.map(item => item.type === 'gifts' ? <LifeStyleCard key={item.id} item={item} /> : null)
                                            }
                                        </Row>
                                    </div>
                                </Tab.Pane>
